            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">프로젝트 작성</h1>
                    </div>

            <!-- Content Row 
            -->
							<div class="container">
								<form method="post" enctype="multipart/form-data" action="${path}/project.do?method=insert">
							...
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									<span class="input-group-text">시작 일자</span>
								</div>
								<input type="date" name="project_startS" class="form-control"
									value='<fmt:formatDate value="${project.project_start}" pattern="yyyy-MM-dd"/>'/> 
								
								<div class="input-group-prepend">
									<span class="input-group-text">종료 일자</span>
								</div>
								<input type="date" name="project_endS" class="form-control" 
									value='<fmt:formatDate value="${project.project_end}" pattern="yyyy-MM-dd"/>'/>
							</div>
							...
							<div class="input-group mb-3 fileCls">	
								...
								<input name="writer" class="form-control" value="${member.name}"
									placeholder="작성자입력하세요" readonly/> 
									<!-- 작성자는 session id으로만 등록/수정 불가 처리 -->	
								<!-- 상위글 번호 필요 없어서 히든처리 -->
								<input type="hidden" name="project_refno" class="form-control" value="${project.project_refno}" readonly/>	
							</div>	
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text">예산 설정</span>
								</div>
								<input name="project_budget" class="form-control" value="${project.project_budget}" placeholder="예산 입력"/>			 
							</div>  	
							<div class="input-group mb-3 fileCls">
								<div class="input-group-prepend">
									<span class="input-group-text">담당자</span>
								</div>
								<input name="project_member" class="form-control" value="${project.project_member}"placeholder="참여 인원 입력"/>
							</div> 
							
							<input type="hidden" name="dname" value="${member.dname}"/>
							<input type="hidden" name="project_manager" value="${member.name}"/>
