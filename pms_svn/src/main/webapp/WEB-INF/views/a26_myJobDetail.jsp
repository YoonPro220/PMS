				...
				<div class="container-fluid">
					...
					<div class="container">
						<form method="post">
							...
							<input type="hidden" name="myjob_list_num" class="form-control" value="${myjob.myjob_list_num}" readonly/>
							
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									<span class="input-group-text">프로젝트 명</span>
								</div>
									<input name="project_name" class="form-control" value="${myjob.project_name}" readonly/>	
							</div>			
							<div class="input-group mb-3">
								...
								<div class="input-group-prepend">
									<span class="input-group-text">상 위 글 번 호</span>
								</div>		 
							...
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									...
									<input name="writer" class="form-control" placeholder="" value="${myjob.writer}" readonly/>	
								<div class="input-group-prepend">
									<span class="input-group-text">담 당 자</span>
								</div>
									<input name="mname" class="form-control" placeholder="" value="${myjob.mname}"/>
							</div>
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
