...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            -->
							<div class="container">
								<form method="post" enctype="multipart/form-data" action="${path}/working.do?method=insert">
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									<span class="input-group-text">프로젝트명</span>
								</div>
								
								<c:if test="${working.working_refno >1}">
										<input name="project_name" class="form-control" value="${working.project_name}" readonly/>
									</c:if>
								<c:if test="${working.working_refno == 0}">
							...
							<div class="input-group mb-3">
								...
								<input name="working_title" class="form-control" value="${working.working_title}" placeholder="제목입력하세요"/>			 
							</div>  	
							<div class="input-group mb-3 fileCls">
								<div class="input-group-prepend">
