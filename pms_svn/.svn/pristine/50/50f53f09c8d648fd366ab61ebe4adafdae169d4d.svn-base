            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">산출물관리 작성</h1>
                    </div>

            <!-- Content Row 
            -->
							<div class="container">
								<form method="post" enctype="multipart/form-data" action="${path}/output.do?method=insert">
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									<span class="input-group-text">프로젝트명</span>
								</div>
								
								<c:if test="${output.output_refno >1}">
										<input name="project_name" class="form-control" value="${output.project_name}" readonly/>
									</c:if>
								<c:if test="${output.output_refno == 0}">
								...
								<input name="dname" class="form-control" value="${member.dname}" readonly/>	
							</div>															
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
							...
							<div class="input-group mb-3">
								...
								<input name="output_title" class="form-control" value="${output.output_title}" placeholder="제목입력하세요"/>			 
							</div>  	
							<div class="input-group mb-3 fileCls">
								<div class="input-group-prepend">
